...
function drawScene() {
  ...
  // COMPLETE THIS SECTION //
  let translationMatrix = m4.translation(translationVector);

  let rotationXMatrix = m4.rotationX(objects.model.transforms.rr.x);
  let rotationYMatrix = m4.rotationY(objects.model.transforms.rr.y);
  let rotationZMatrix = m4.rotationZ(objects.model.transforms.rr.z);

  let scaleMatrix = m4.scale(scaleVector);
  ...
  transforms = m4.multiply(transforms, scaleMatrix);
  transforms = m4.multiply(transforms, rotationXMatrix);
  transforms = m4.multiply(transforms, rotationYMatrix);
  transforms = m4.multiply(transforms, rotationZMatrix);
  transforms = m4.multiply(transforms, translationMatrix);
